...
<template>
  ...
  >
    ...
    <div v-if="controlDevices.length > 0" class="mt-5 grid gap-4 xl:grid-cols-2">
      <div
      ...
      >
        ...
        <div v-else-if="device.control_kind === 'number'" class="mt-4">
          ...
          <input
            ...
            :style="{ accentColor: applianceType === 'tv' ? '#6366f1' : applianceType === 'air_conditioner' ? '#14b8a6' : applianceType === 'fridge' ? '#0ea5e9' : '#f59e0b' }"
